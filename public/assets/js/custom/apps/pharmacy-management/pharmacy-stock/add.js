...
// Class definition
var KTUsersAddPharmacyStock = function () {
    // Shared variables
    ...
    var initAddPharmacyStock = () => {
        ...
        const submitButton = element.querySelector('[data-kt-pharmacies-stock-modal-action="submit"]');
        submitButton.addEventListener('click', e => {
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        let formData = new FormData($("#kt_modal_pharmacy_stock_form")[0]);

                        let selectedTreatments = $('#treatment_id_1').val();
                        ...
                        $.ajaxSetup({
                            ...
                            $.ajax({
                                type: "POST",
                                url: "admin/stock-pharmacy-management/add",
                                data: formData,
                                ...
                                success: function (response) {
                                    ...
                                    setTimeout(function () {
                                        ...
                                        $('#treatment_id_1').val(null).trigger('change');
        ...
        const cancelButton = element.querySelector('[data-kt-pharmacies-stock-modal-action="cancel"]');
        ...
        const closeButton = element.querySelector('[data-kt-pharmacies-stock-modal-action="close"]');

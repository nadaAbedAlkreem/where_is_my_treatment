...
var KTPharmacyUpdateUser = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_update_pharmacy');
    const form = element.querySelector('#kt_modal_update_pharmacy_form');
            ...
            form,
            {
                fields: {
                    ...
                    'license_expiry_date': {
                        validators: {
                            notEmpty: {
                                message: 'تاريخ انتهاء ترخيص مطلوب'
                            }
                        }
                    },
                    'email_pharmacy': {
                    ...
                    'status_exist': {
                        validators: {
                            notEmpty: {
                                message: 'قيمة فتح او اغلاق الصيدلية مطلوبة'
                            }
                        }
                    },
                    'description': {
                        validators: {
                            notEmpty: {
                                message: 'تفاصيل الصيدلية مطلوية '
                            }
                        }
                    },
                    'working_hours': {
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status === 'Valid') {
                        ...
                        let formData = new FormData($("#kt_modal_update_pharmacy_form")[0]);
                         const form = document.getElementById("kt_modal_update_pharmacy_form");

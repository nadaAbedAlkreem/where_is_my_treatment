...
var KTEmployeeList = function () {
    ...
    var table = document.getElementById('kt_table_pharmacy_owner');
    var datatable;
    var toolbarBase;
    var toolbarSelected;
    var selectedCount;
    ...
    var initEmployeeTable = function () {
        ...
        $('#submit-status-ph').on('click', function () {
            $(".data-table-pharmacy-owner").DataTable().ajax.reload();
        });
        // Init datatable --- more info on datatables: https://datatables.net/manual/
        var  datatable = $('.data-table-pharmacy-owner').DataTable({
            ...
            info: true,
            ajax: {
                url: "admin/pharmacy-owner-management",
                data: function (d) {
                    d.search_pharmacy_owner= $('#search-pharmacy-owner').val();
                    d.search_status_user= $('#status-user').val();
                    d.search_status_approved= $('#status-approved').val();
            ...
            columns: [
                ...
                {data: 'status_approved_for_pharmacy', name: 'status_approved_for_pharmacy'},
        ...
        $('.data-table-pharmacy-owner').on('click', '.deleteRecord[data-id]', function (e) {
            e.preventDefault();
            var id = $(this).data("id");
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "admin/pharmacy-owner-management/"+ id,
                        type: 'DELETE',
                        data: {
                            "id": id,
                            "_token": token,
        ...
        $(".data-table-pharmacy-owner").on("click", ".blockRecord[data-id]", function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "admin/pharmacy-owner-management/update-status/" + id + "/" +status,
                        type: "GET",
                        data: {
                            id: id,
                            _token: token,

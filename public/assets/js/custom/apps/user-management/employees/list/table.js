...
var KTEmployeeList = function () {
    ...
    var table = document.getElementById('kt_table_employee');
    var datatable;
    var toolbarBase;
    var toolbarSelected;
    var selectedCount;
    ...
    var initEmployeeTable = function () {
        ...
        var  datatable = $('.data-table-employee').DataTable({
            ...
            columns: [
                ...
                {data: 'pharmacyOwner', name: 'pharmacyOwner'},
        ...
        $('.data-table-employee').on('click', '.deleteRecord[data-id]', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "admin/employee-management/"+ id,
                        type: 'DELETE',
                        data: {
                            "id": id,
                            "_token": token,
        ...
        $('.data-table-employee').on('click', '.updateRe', function (e) {
        ...
        $('.data-table-employee').on("click", ".blockRecord[data-id]", function (e) {
            e.preventDefault();
            var id = $(this).data("id");
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "admin/employee-management/update-status/" + id + "/" +status,
                        type: "GET",
                        data: {
                            id: id,
                            _token: token,

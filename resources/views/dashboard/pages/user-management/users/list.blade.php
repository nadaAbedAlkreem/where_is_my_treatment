...
@section('content')
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bolder my-1 fs-3">قائمة المستخدمين</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-600">المستخدمين</li>
                <!--end::Item-->
    ...
    <div class="content flex-column-fluid" id="kt_content">
        ...
        <div class="card">
            ...
            <div class="card-body py-4">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5 data-table-users" id="kt_table_users_app">
                    <!--begin::Table head-->
                    <thead>
                    <!--begin::Table row-->

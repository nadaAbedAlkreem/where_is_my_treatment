                      ...
                      <!--begin::Action=-->
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a data-bs-toggle="modal" data-bs-target="#kt_modal_update_category"  data-id="' . $data->id . '" data-name="' . $data->name . '"  data-image="' . $data->image . '"  data-description="' . $data->description . '"  class="menu-link px-3 updateRe">تعديل</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
